...
[Case Study: Fair Models](<../Case Study 2/case_study2.html>) provides a full insurance implementation using generalised linear models (GLMs) and XGBoost (a machine learning algorithm based on decision trees).

Governance readers, see [Implementation](#implementation) and [Checklist](#checklist). Model development, see [Model designs](#model-designs). Full example, see [Case Study: Fair Models](<../Case Study 2/case_study2.html>).
:::
...
The [case study](<../Case Study 2/case_study2.html>) shows one insurance implementation. Adapt data, variables, and packages to your jurisdiction.
:::
...
| $\hat{Y}$ | Predicted value of the chosen outcome variable. Pure premium by default in this step's models, per the [scope note](#scope-of-this-step) above |
...
This is the model design that best maps to conditional demographic parity (CDP), which is the criterion most directly relevant to regulatory proposals in Colorado and New York. [Case Study: Fair Models](<../Case Study 2/case_study2.html>) works through a full implementation.
...
**Next:** [Step 3 · Assess Impact](Step-3-Assess-Impact.html) — trace price effects through demand and competition after the model is built. Or see [Case Study: Fair Models](../Case%20Study%202/case_study2.html) for implementation in R.
:::
