...
The advantage is better predictive accuracy: MC uses all available information in estimating expected costs. The price each customer sees does not directly use their protected group membership, but the model's internal estimates do. This approach was introduced as the discrimination-free price by @lindholm2022discrimination and implemented in the insurance context by @xin2024antidiscrimination. It targets the fairness criterion of controlling for the protected variable (CPV).
