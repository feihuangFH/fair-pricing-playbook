...
The advantage is better predictive accuracy: MC uses all available information in estimating expected costs. The price each customer sees does not directly use their protected group membership, but the model's internal estimates do. This approach is sometimes called a discrimination-free price [@xin2024antidiscrimination]. It targets the fairness criterion of controlling for the protected variable (CPV).
