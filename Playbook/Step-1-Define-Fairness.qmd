...
| No omitted-variable bias (proxy discrimination) [@pope2011implementing; @lindholm-etal-2022-discrimination] | Diagnose proxy relationships with protected attributes and adjust for their effect on outputs | Remove the effect of race or ethnicity on model outputs after diagnosing proxy relationships |
