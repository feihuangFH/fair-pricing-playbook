...
| Counterfactual fairness [@araiza2022discrimination; @cote2025fair] | A prediction is fair if it would be the same in a counterfactual world where the individual belonged to a different protected group, all else being equal | Equal premium for a customer regardless of which group they belong to, holding all causally legitimate factors fixed |
