...
When race or ethnicity cannot be observed directly, regulators and firms sometimes infer it using BISG (Bayesian Improved Surname Geocoding), BIFSG (Bayesian Improved First Name Surname Geocoding), zip composition, or similar methods. If that proxy enters the audit regression as a categorical protected attribute, the estimated price gap for the proxy group is not the same quantity as the true gap between groups [@xin2026proxyrace].
