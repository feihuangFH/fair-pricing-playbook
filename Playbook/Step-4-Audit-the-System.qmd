...
[Case Study: Fairness Testing](<../Case Study 4/case_study4.html>) implements conditional demographic parity (CDP) and proxy discrimination (PD) audits with corrected inference.

Compliance workflow, see [End-to-end audit flow](#end-to-end-audit-flow) → [Checklist](#checklist). Statistical detail, see [Deterministic pricing](#deterministic-pricing) → [Case Study: Fairness Testing](<../Case Study 4/case_study4.html>). Proxied attributes (BISG, BIFSG, zip), see [Proxied protected attributes](#proxied-protected-attributes).
:::
...
The [case study](<../Case Study 4/case_study4.html>) applies one illustrative design to Illinois auto quotes. Adapt criteria, data, and escalation rules to your jurisdiction.
:::
...
Regression formulas, corrected standard errors, and TOST decision rules are worked through in [Case Study: Fairness Testing](<../Case Study 4/case_study4.html>).
:::
...
The protocol above tests whether premiums or prices meet quantitative fairness criteria such as CDP or proxy discrimination after legitimate controls. That is the primary audit path in this playbook and in [Case Study: Fairness Testing](<../Case Study 4/case_study4.html>).

Some filing and governance workflows use a different, variable-level check instead: partial dependence plots and related interpretability tools ask whether a given rating factor appears to influence model predictions. This variable-level check asks whether a rating factor influences model predictions. It does not establish whether average outcomes are equal across protected groups.
...
**Completed the four steps.** Return to the [Overview](../index.html) or see [Case Study: Fairness Testing](../Case%20Study%204/case_study4.html) for implementation in Python.
:::
