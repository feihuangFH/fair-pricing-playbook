...
- A fair cost model does not guarantee a fair outcome. Price optimisation, demand elasticity, and competitive dynamics can reintroduce group disparities after cost-level fairness is achieved. Prediction-level fairness is a necessary starting point, not a sufficient end state.
