...
- When race or ethnicity cannot be directly observed and is instead estimated from name or geography (using methods such as BISG or BIFSG), the estimated price gap does not equal the true group disparity. Additional corrections are required in this case.
:::
