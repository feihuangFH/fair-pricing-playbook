...
- A clean audit must demonstrate compliance, not merely fail to find a violation. Equivalence testing asks whether any price gap is small enough to fall within a pre-specified tolerance band. Insufficient data yields an inconclusive result, not a pass.
