...
- The fairness–accuracy trade-off is real but manageable. On a benchmark auto insurance dataset, fair models using XGBoost (a machine learning algorithm) retained most predictive power while substantially reducing group premium disparities.
