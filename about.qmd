...
For academic publications, please cite the report. For web references or general use, cite the website.

### Citing the report (recommended for academic publications)
...
@misc{huang2026fairpricingplaybook,
  ...
  url       = {https://doi.org/10.2139/ssrn.6955039}
}
```

:::

### Citing the website (for web references or general use)

Huang, F. (2026). *The Fair Pricing Playbook*. Retrieved June 2026, from https://fair.feihuang.org
...
@misc{huang2026fairpricingplaybook_website,
  ...
  author       = {Huang, Fei},
  year         = {2026},
  howpublished = {\url{https://fair.feihuang.org}},
